...
#define _syscall0(type,name) \
     ...
     { \
          long __res; \
          if (Z1(__NR_##name)) { \
               __asm__ __volatile__("push %[sysN]; popl %0; int $0x80" : "=a"(__res) : [sysN] "g"(__NR_##name)); \
          } \
          else { \
               __asm__ __volatile__("int $0x80" : "=a"(__res) : [sysN] "a"(__NR_##name)); \
          } \
          return (type)__res; \
     }
...
#define _syscall1(type,name,type1,arg1) \
     ...
     { \
          ...
          if (Z1(__NR_##name)) { \
               ...
               __asm__ __volatile__("int $0x80" : "=a"(__res), "=b"(junk) : "a"(__NR_##name), "b"((long)(arg1))); \
          } \
          return (type)__res; \
     }
...
#define _syscall1noreturn(name,type1,arg1) \
     ...
     { \
          if (Z1(__NR_##name)) { \
               if (Z0(arg1)) { \
                    __asm__ __volatile__("xorl %%ebx,%%ebx; push %0; popl %%eax; int $0x80" : : "g"(__NR_##name)); \
               } \
               else if (Z1(arg1)) { \
                    ...
                    __asm__ __volatile__("push %0; popl %%eax; int $0x80" : : "g"(__NR_##name), "b"((long)(arg1))); \
               } \
          } \
          else { \
               __asm__ __volatile__("int $0x80" : : "a"(__NR_##name), "b"((long)(arg1))); \
          } \
          for (;;) \
               ; \
     }
          ...
          if (Z1(__NR_##name)) { \
               if (Z0(arg1) && Z0(arg2)) { \
                    ...
                    __asm__ __volatile__( \
                       "push %[a2]; popl %%ecx; push %[a1]; popl %%ebx; push %[sysN]; popl %0; int $0x80" \
                       : "=a"(__res) \
...
#define _syscall3(type,name,type1,arg1,type2,arg2,type3,arg3) \
     ...
     { \
          ...
          if (Z1(__NR_##name)) { \
               __asm__ __volatile__( \
                  "push %[sysN]; popl %0; int $0x80" \
                  : "=a"(__res), "=b"(junkb), "=c"(junkc), "=d"(junkd) \
                  : [sysN] "g"(__NR_##name), "b"((long)(arg1)), "c"((long)(arg2)), "d"((long)(arg3))); \
          } \
          else { \
               __asm__ __volatile__( \
                  "int $0x80" \
                  : "=a"(__res), "=b"(junkb), "=c"(junkc), "=d"(junkd) \
                  : [sysN] "a"(__NR_##name), "b"((long)(arg1)), "c"((long)(arg2)), "d"((long)(arg3))); \
          } \
          return (type)__res; \
     }
...
static inline _syscall2(int, access, const char *, file, int, mode) static inline _syscall1(
   int,
   adjtimex,
   struct timex *,
   ntx) static inline _syscall1(void *,
                                brk,
                                void *,
                                high) static inline _syscall1(int, close, int, fd) static inline _syscall3(int, execve, const char *, file, char **, argv, char **, envp) static inline _syscall1noreturn(_exit,
                                                                                                                                                                                                          int,
                                                                                                                                                                                                          exitcode) static inline _syscall3(int, fcntl, int, fd, int, cmd, long, arg) static inline _syscall0(pid_t, fork) static inline _syscall2(int, ftruncate, int, fd, size_t, len) static inline _syscall0(pid_t, getpid) static inline _syscall2(int, gettimeofday, struct timeval *, tv, void *, tz) static inline _syscall3(off_t,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     lseek,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     int,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     fd,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     off_t,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     offset,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     int,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     whence) static inline _syscall3(int,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     mprotect,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     void
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        *,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     addr,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     len,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     int,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     prot) static inline _syscall2(int, munmap, void *, start, size_t, length) static inline _syscall2(int, nanosleep, const struct timespec *, rqtp, struct timespec *, rmtp) static inline _syscall3(int,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       open,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       const char
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          *,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       file,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       flag,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       int,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       mode) static inline _syscall3(ssize_t,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     read,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     int,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     fd,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     void
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     buf,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     size_t,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     count) static inline _syscall3(pid_t,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    waitpid,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    pid_t,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    pid,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    int
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    wait_stat,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    int,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    options) static inline _syscall3(ssize_t,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     write,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     int,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     fd,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     const void
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     buf,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     size_t,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     count) static inline _syscall1(int,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    unlink,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    const char
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       *,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    file) static inline _syscall2(int,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  link,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  const char
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     *,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  src,
...
#define __NR_read (3 + 4000)
     ...
     __asm__ __volatile__("bal sysgo" : "+r"(v0) : "r"(a0), "r"(a1), "r"(a2) : "a3", "ra");
     return v0;
}
...
#define __NR_brk (45 + 4000)
     ...
     __asm__ __volatile__("bal sysgo" : "+r"(v0) : "r"(a0) : "a3", "ra");
     return v0;
}
...
#define __NR_munmap (91 + 4000)
     ...
     __asm__ __volatile__("bal sysgo" : "+r"(v0) : "r"(a0), "r"(a1) : "a3", "ra");
     return v0;
}
